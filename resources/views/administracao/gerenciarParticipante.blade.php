...
<head>
  ...
  <link href="<?= url('assests/sistema/vendor/datatables/dataTables.bootstrap4.min.css')?>" rel="stylesheet">
</head>
...
<body id="page-top">
  ...
  <!-- <script src="vendor/datatables/jquery.dataTables.min.js"></script> -->
    <script src="<?= url('assests/sistema/vendor/datatables/jquery.dataTables.min.js')?>"></script>
    <script src="<?= url('assests/sistema/vendor/datatables/dataTables.bootstrap4.min.js')?>"></script>
