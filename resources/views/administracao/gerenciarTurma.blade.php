        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Gerenciar turma</li>
            </ol>
          </div>
            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card">
                ...
                <div class="card-footer">
                  <a href="" class="btn btn-success">Turma anterior</a>
                  <a href="" class="btn btn-info">Próxima turma</a>
                  <a href="" class="btn btn-primary">Editar turma</a>
                  <a href="" class="btn btn-primary">Finalizar turma</a>
