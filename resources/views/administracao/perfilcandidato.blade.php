...
<h5 class="modal-title" id="exampleModalLabel">Confirmar matricula com a candidato</h5>
<button type="button" class="close" data-dismiss="modal" aria-label="Close">
<span aria-hidden="true">&times;</span>
</button>
</div>
<form class="" action="'.url('Administracao/MatricularCandidato').'" method="post">
<input type="hidden" value="'.$idUSu ?? ''.'" name="idusuario">
 <label class="text-center">Nome: '.$nome.' ' .$infobasic['sobrenome'].'</label>
 <br>
 <label class="text-center">E-mail: '.$infobasic['email'].'</label>
<br>
...
<button type="submit" class="btn btn-primary">Save changes</button>
                        ...
                        {{-- <a class='btn btn-success mb-4 mt-2' href='".url('cadastro/cadastroemturma')."'>Selecionar para uma entrevista</a>
