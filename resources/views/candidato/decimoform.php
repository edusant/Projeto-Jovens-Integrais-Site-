...
<head>
 ...
 <body>
  ...
  <div class="conteudo">
    ...
    <div class="row">
      <div class="col-md-6">
        <img style="width: 100%" src="<?= base_url('assests/img/form/undraw_buddies_tb1l.svg') ?>">
    ...
    <form method="post" id="dadosestu" action="<?= base_url('Cadastro/cadastrarinfopartequatro') ?>">
      <div class="form-group">
        <div class="form-group">
       <label class="h5">O que você acha que tá faltando para melhorar sua qualidade de vida</label>
       <textarea class="form-control" name="melhorqualidadevida" rows="4" cols="11">
         
       </textarea>
     </div>
      <div class="form-group">
       <label class="h5">Em casa de necessidade, qual é a sua rede de apoio? </label>
          <div class="row">
      <div class="col-md-6">
...
<script>
  ...
  $.ajax({
    ...
    $.ajax({
      ...
      success: function(data){
        dados = JSON.parse(data)
        if(dados.melhorqualidadevida !== undefined)
        {
          $('[name=melhorqualidadevida]').val(dados.melhorqualidadevida)
        }
      }
    })
