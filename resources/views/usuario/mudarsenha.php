        ...
        <div class="container-fluid" id="container-wrapper">
          <p class="h1">Mudar senha</p>
            ...
            <form  action="nsenhando.php" id="tratar" method="post">
                ...
                <input type="password" name="novasenha" class="form-control" id="novasenha"><br>
                <label for="repitasenha">Repita a nova senha:</label>
                <input type="password" name="repitasenha" class="form-control" id="repitasenha">
